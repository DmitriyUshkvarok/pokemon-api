...
(Curtains.prototype._init = function () {
  ...
  (Curtains.prototype.setPixelRatio = function (t) {
  ...
  (Curtains.prototype._createPlane = function (t, e) {
    return new Curtains.Plane(this, t, e);
  }),
  ...
  (Curtains.prototype.removePlane = function (t) {
    t._canDraw = !1;
    for (var e, i = this._drawStack, r = 0; r < i.length; r++)
      t.index === i[r] && this._drawStack.splice(r, 1);
    t && t._dispose();
    for (r = 0; r < this.planes.length; r++)
      t.index === this.planes[r].index && (e = r);
    (t = null),
      (this.planes[e] = null),
  ...
  (Curtains.Plane.prototype._init = function (t, e) {
    ...
    if (
      ...
      if (
        ...
        for (
          var n = [], o = 0;
          o < this.htmlElement.getElementsByTagName('img').length;
          o++
        )
          n.push(this.htmlElement.getElementsByTagName('img')[o]);
        n.length > 0 && this.loadSources(n);
        var s = [];
        for (
          o = 0;
          o < this.htmlElement.getElementsByTagName('video').length;
          o++
        )
          s.push(this.htmlElement.getElementsByTagName('video')[o]);
        s.length > 0 && this.loadSources(s);
        var h = [];
        for (
          o = 0;
          o < this.htmlElement.getElementsByTagName('canvas').length;
          o++
        )
          h.push(this.htmlElement.getElementsByTagName('canvas')[o]);
      ...
      r = setInterval(function () {
        l._loadingManager.sourcesLoaded >=
          ...
          (clearInterval(r), l._onReadyCallback && l._onReadyCallback());
      }, 16);
    }
  }),
  (Curtains.Plane.prototype._setInitParams = function (t) {
    ...
    var i = this;
    t.uniforms &&
      Object.keys(t.uniforms).map(function (e, r) {
        var a = t.uniforms[e];
        i.uniforms[e] = { name: a.name, type: a.type, value: a.value };
      });
  }),
  (Curtains.Plane.prototype._setupShaders = function (t) {
    var e,
      i,
      r = this._wrapper,
      a = t.vertexShaderID || this.htmlElement.getAttribute('data-vs-id'),
      n = t.fragmentShaderID || this.htmlElement.getAttribute('data-fs-id');
    t.vertexShader ||
      (a && document.getElementById(a)
        ? (e = document.getElementById(a).innerHTML)
        : (r.productionMode ||
  ...
  (Curtains.Plane.prototype._setComputedSizes = function () {
    var t = this._wrapper,
      ...
      r = t._boundingRect.width / 2 + t._boundingRect.left,
      a = t._boundingRect.height / 2 + t._boundingRect.top;
  ...
  (Curtains.Plane.prototype._setAttributes = function () {
    ...
    Object.keys(t).map(function (i, r) {
      ...
      e._attributes[i] = {
        name: a,
        location: e._wrapper.glContext.getAttribLocation(e._program, a),
      };
    });
  }),
  (Curtains.Plane.prototype._handleUniformSetting = function (t, e, i) {
  ...
  (Curtains.Plane.prototype._setUniforms = function (t) {
    var e = this._wrapper;
    e.glContext.useProgram(this._program);
    var i = this;
    t &&
      Object.keys(t).map(function (r, a) {
        var n = t[r];
        (i.uniforms[r].location = e.glContext.getUniformLocation(
          i._program,
          n.name
        )),
          n.type ||
          ...
          i._handleUniformSetting(n.type, i.uniforms[r].location, n.value);
      });
  }),
    ...
    if (this.uniforms) {
      ...
      Object.keys(t.uniforms).map(function (e) {
        var i = t.uniforms[e],
          ...
          a = i.value,
          n = i.type;
        t._handleUniformSetting(n, r, a);
      });
    }
  }),
  (Curtains.Plane.prototype._multiplyMatrix = function (t, e) {
    var i = [],
      r = t[0],
      a = t[1],
      n = t[2],
    ...
    return (
      ...
      (i[8] = v * r + C * s + y * d + b * m),
      (i[9] = v * a + C * h + y * p + b * f),
      (i[10] = v * n + C * l + y * c + b * g),
      (i[11] = v * o + C * u + y * _ + b * x),
      (v = e[12]),
      (C = e[13]),
      (y = e[14]),
      (b = e[15]),
      (i[12] = v * r + C * s + y * d + b * m),
      (i[13] = v * a + C * h + y * p + b * f),
      (i[14] = v * n + C * l + y * c + b * g),
      (i[15] = v * o + C * u + y * _ + b * x),
      i
    );
  }),
  (Curtains.Plane.prototype._scaleMatrix = function (t, e, i, r) {
    ...
    return (
      ...
      (a[11] = r * t[11]),
      t !== a &&
        ((a[12] = t[12]), (a[13] = t[13]), (a[14] = t[14]), (a[15] = t[15])),
      a
    );
  }),
  (Curtains.Plane.prototype._setPerspectiveMatrix = function (t, e, i) {
    var r =
      this._wrapper._boundingRect.width / this._wrapper._boundingRect.height;
    return (
  ...
  (Curtains.Plane.prototype.setPerspective = function (t, e, i) {
    ...
    var a = parseFloat(e) || 0.1,
      n = parseFloat(i) || 100;
    this._matrices &&
      ((this._matrices.pMatrix.matrix = this._setPerspectiveMatrix(r, a, n)),
  ...
  (Curtains.Plane.prototype._setTranslation = function () {
    var t = { x: 0, y: 0 };
    (0 === this.relativeTranslation.x && 0 === this.relativeTranslation.y) ||
  ...
  (Curtains.Plane.prototype.setRelativePosition = function (t, e) {
    (this.relativeTranslation = { x: t, y: e }), this._setTranslation();
  }),
  (Curtains.Plane.prototype._documentToPlaneSpace = function (t, e) {
    var i = this._wrapper;
    return {
      x:
  ...
  (Curtains.Plane.prototype.mouseToPlaneCoords = function (t, e) {
    var i =
      ...
      n =
        (this._boundingRect.document.height * this.scale.y) /
        this._wrapper.pixelRatio,
      o = (this._boundingRect.document.top + r) / this._wrapper.pixelRatio;
    return {
      x:
        ((t -
          (this._boundingRect.document.left + i) / this._wrapper.pixelRatio) /
          a) *
          2 -
        1,
      y: 1 - ((e - o) / n) * 2,
  ...
  (Curtains.Plane.prototype._shouldDrawCheck = function () {
    ...
    i > this._wrapper._boundingRect.height + 0
      ? this._shouldDraw &&
        ((this._shouldDraw = !1),
        setTimeout(function () {
          o._onLeaveViewCallback && o._onLeaveViewCallback();
        }, 0))
      : (this._shouldDraw ||
          setTimeout(function () {
            o._onReEnterViewCallback && o._onReEnterViewCallback();
          }, 0),
        (this._shouldDraw = !0));
  }),
  ...
  (Curtains.Plane.prototype.createTexture = function (t) {
    return new Curtains.Texture(this, {
      index: this.textures.length,
      sampler: t,
    });
  }),
  (Curtains.Plane.prototype.loadSources = function (t) {
    for (var e = 0; e < t.length; e++) this.loadSource(t[e]);
  }),
  (Curtains.Plane.prototype.loadSource = function (t) {
  ...
  (Curtains.Plane.prototype.loadImage = function (t) {
    var e = t;
  ...
  (Curtains.Plane.prototype.loadVideo = function (t) {
    var e = t;
    (e.preload = !0),
      (e.muted = !0),
      (e.loop = !0),
  ...
  (Curtains.Plane.prototype.loadCanvas = function (t) {
    var e = t;
    e.sampler = t.getAttribute('data-sampler') || null;
    var i = this.createTexture(e.sampler);
    this.canvases.push(e), i._onSourceLoaded(e);
  }),
  (Curtains.Plane.prototype.loadImages = function (t) {
    for (var e = 0; e < t.length; e++) this.loadImage(t[e]);
  }),
  (Curtains.Plane.prototype.loadVideos = function (t) {
    for (var e = 0; e < t.length; e++) this.loadVideo(t[e]);
  }),
  (Curtains.Plane.prototype.loadCanvases = function (t) {
  ...
  (Curtains.Plane.prototype._bindPlaneTexture = function (t) {
  ...
  (Curtains.Plane.prototype._drawPlane = function () {
    ...
    if (
      ...
      this._bindPlaneBuffers(),
        t.drawArrays(t.TRIANGLES, 0, this._geometry.bufferInfos.numberOfItems);
    }
  }),
  (Curtains.Plane.prototype._dispose = function () {
    for (var t = this._wrapper.glContext, e = 0; e < this.textures.length; e++)
  ...
  (Curtains.Plane.prototype.onLoading = function (t) {
    return t && (this._onPlaneLoadingCallback = t), this;
  }),
  (Curtains.Plane.prototype.onReady = function (t) {
  ...
  (Curtains.Plane.prototype.onRender = function (t) {
  ...
  (Curtains.Texture.prototype._init = function () {
    ...
    this._textureMatrix = {
      name: r,
      matrix: null,
      location: t.getUniformLocation(this._plane._program, r),
    };
  }),
  ...
  (Curtains.Texture.prototype._getSizes = function () {
    ...
    return (
      n > a
        ? (s = Math.min(0, e - t * (1 / a)))
        : n < a && (o = Math.min(0, t - e * a)),
      {
        planeWidth: t,
        planeHeight: e,
        sourceWidth: i,
  ...
  (Curtains.Texture.prototype._dispose = function () {
    'video' === this.type
      ? (this.source.removeEventListener(
        ...
        this.source.load(),
        this.source.updateInterval && clearInterval(this.source.updateInterval))
      : 'canvas' === this.type
